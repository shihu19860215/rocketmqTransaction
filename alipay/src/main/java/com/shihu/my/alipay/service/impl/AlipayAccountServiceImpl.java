...
import com.shihu.my.alipay.dao.AccountDao;
...
public class AlipayAccountServiceImpl implements AlipayAccountService{
    ...
    @Autowired
    private AlipayTransferRecordService transferRecordService;
    @Autowired
    ...
    public boolean payToICBC(long id, long amount) {
        return!payToOther(id,amount,"alipayToICBC");
    }

    @Override
    public boolean payToABC(long id, long amount) {
        return!payToOther(id,amount,"alipayToABC");
    }
