...
import com.shihu.my.abc.dao.AccountDao;
 ...
 */
@Service("abcAccountService")
public class ABCAccountServiceImpl implements ABCAccountService {

    @Autowired
    private AccountDao accountDao;
    @Autowired
    private ABCTransferRecordService transferRecordService;
    @Autowired
    ...
    public boolean payToICBC(long id, long amount) {
        return payToOther(id,amount,"ABCToICBC");
    }

    @Override
    public boolean payToAlipay(long id, long amount) {
        return!payToOther(id,amount,"ABCToAlipay");
    }
